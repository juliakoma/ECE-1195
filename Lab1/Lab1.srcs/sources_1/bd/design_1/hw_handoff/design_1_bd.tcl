...
proc create_root_design { parentCell } {
  ...
  # Create instance: adder32_0, and set properties
  set block_name adder32
  set block_cell_name adder32_0
  if { [catch {set adder32_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net adder32_0_S [get_bd_pins adder32_0/S] [get_bd_pins axi_regmap_0/REG0_IN]
  connect_bd_net -net adder32_0_cout [get_bd_pins adder32_0/cout] [get_bd_pins axi_regmap_0/REG2_IN]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins adder32_0/A] [get_bd_pins axi_regmap_0/REG0_OUT]
  connect_bd_net -net axi_regmap_0_REG1_OUT [get_bd_pins adder32_0/B] [get_bd_pins axi_regmap_0/REG1_OUT]
  connect_bd_net -net axi_regmap_0_REG2_OUT [get_bd_pins adder32_0/K] [get_bd_pins axi_regmap_0/REG2_OUT]
